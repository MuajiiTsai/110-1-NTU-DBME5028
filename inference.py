...
output_csv = args.datapath + f'/{output_filename}.csv'
...
test_output = pd.read_csv(args.datapath + '/output_with_seed.csv')
...
test_output_merge.to_csv(args.output_csv_path + '/output_with_seed_merge.csv', index=False)